...
public abstract class GameObject extends JComponent {
    ...
    public GameObject(BufferedImage img, ImageObserver observer) {
        ...
        try {
            ...
            System.out.println("NullPointerException for TankGame.GameObject(Image, ImageObserver)\n");
            this.width = 0;
            this.height = 0;
        }
    ...
    public GameObject(int x, int y, BufferedImage img, ImageObserver observer) {
        ...
        try {
            ...
            System.out.println("NullPointerException for TankGame.GameObject(int, int, Image, ImageObserver)\n");
            this.width = 0;
            this.height = 0;
        }
